...
def task2():
    global bond_points 
    print (f" \n TASK 2\n{name}'s next task is to sweep the chimney in the royal lounge. {name} climbs in and gets to work.")
    print("You haved watched this task countless times but something feels off...")
    print("You see a maid walk in, talking of the heir demanding a bath.")
    print("She is carrying logs and a bucket of water.")
    print("Will you intervene ? Yes/No")
    task1 = input ()
    if task1.lower() == "yes":
        print(f"You panick a second then see a way out. As the maid puts the logs in the fire and the bucket over it-")
        print("You lightly nudge the bucket. The water spills out onto the logs.")
        print("The logs do not light and the maid rushes off to fetch more")
        print("Before she can return, {name} emerges blackened with soot, but healthy nonetheless.")
        bond_points += 1
        print (f"+ {bond_points} BP")
        input("Press enter to continue")
    elif task1.lower() == "no":
        print ("The maid hums to herself as she puts the logs in the fireplace,")
        print("She starts the fire and waits for the water to boil.")
        print(f"It doesn't take long for {name} to realise what has happened,") 
        print("The smoke engulfs them, they cough as it enters their lungs")
        print("Their eyes sting and fill with tears, the walls heat up, ")
        print("their hands burning from holding themselves up")
        print("They slip and fall into the water, body covered in soot and burns")
        print(f"The maid screams at the sight, {name}'s body is in the logs, they try to move but their strength fails them.")
        print(f"You have failed to protect {name}")
        may_you_rip()
        ...
        if death_choice.lower() == "yes":
            ...
            print()
            print(f"Well damn, really all about that murder? Alright, you fall from grace and {name} is dead. Happy?")
            may_you_rip()
            quit()
...
def show_intro_message():
    ...
    print("You realise that to finish your quest, you must navigate the labyrinth you find yourself in.\n")
    print("So, you stiffen your resolve and continue onwards.\n Surely there is a way to get through ... \n")
    print("Labyrinth Instructions.")
    print("=======================")
    ...
    print("Navigate the labyrinth to continue on your quest...\n\n")
...
def consume_main_course():
    ...
    if user_input.upper() == "E":
        ...
        while (user_input.upper() != "X"):
            ...
            #end of if
        #end of while
        print ("\n\n\nThank for trying the maze/labyrinth.")
...
def examine_tapestry():
    ...
    if  blind_gargoyles == True:
            ...
            def enter_combat():
                ...
                print(f"You and {name} ascend the spiral staircase. \n Upon reaching the top floor of the central tower you find the crown encased in glass.\n {name} takes a few steps forward... \n And is intercepted by a living suit of armour ! \n {name} barely has time to act- they grab the nearest candelabra and brace for battle !")
                ...
                while (enemy_health > 0) and (player_health > 0):
                    ...
                    print_health(3, f"{name}", player_health, 20)
                    ...
                    if enemy_health <= 0:
                        ...
                        print(f"With a few more cautious steps, {name} reaches the crown unharmed. They shatter the glass and the crown along with it. \n The final artifact has been destroyed... \n {name} is now ready to face the final battle...")
                        print("")
                        print(f"{name} takes one final rest before the fight.")
        ...
        if enemy_health <= 0:
            ...
            if bond_point == 4:
                ...
                list_of_speech([f"{name} pauses, watching the demon. They step forward, still gripping you tightly in your sword form", 
                                ...
                                f"The Demon has abandoned its old ways, it helps {name} with royal duties now."
