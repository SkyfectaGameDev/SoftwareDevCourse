...
if gender.upper() == "M":
    ...
    gendered_lang = ("She",   "Her",   "Her",    "Hers",    "Princess",  "is")      # Use "gendered_language[x]" (with x being between a number between 0-5) whenever you need them in a sentence, like below.
elif gender.upper() == "N":
...
def show_health():
    ...
    print (f"{name}'s Health: [", *health_bar, f"\033[0m] {health}/15", sep="")     # This prints the health bar. Remember to call this AFTER making changes to health to accurately represent it.
    print ()
