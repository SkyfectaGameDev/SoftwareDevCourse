...
def task3():
    ...
    task1 = input ()
    if task1.lower() == "yes":
       task1 = input(f"{name} decides to sort the library. A certain book is out of place: 'Encyclopedia of Toxic Plants'. Will you read it ? ( enter '0' to read or '1' to put away)")
       if task1 == "0":
...
def show_intro_message():
    ...
    print("You realise that to finish your quest, you must navigate the labrynth you find yoursel in.\n")
    ...
    print("Navigate the labrynth of to continue on your quest...\n\n")
    print("Decision.")
    print("=======================")
